...
class CustomPagination(PageNumberPagination):
    """
        ...
        Константы:
        - PAGINATION_PAGE_SIZE (int): Количество элементов на странице по умолчанию.

        Методы:
        - get_page_size(self, request): Возвращает количество элементов на странице.
        - get_paginated_response(self, data): Возвращает ответ с данными, пагинацией и метаданными.
    """
